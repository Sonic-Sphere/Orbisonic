# Auro 9.1 — Sonic Sphere renderer spec

- **Layout id:** `auro_9_1`  ·  **Family:** auro  ·  **Channels:** 10  ·  **Sub:** discrete LFE + mono bass downmix
...
Auro-3D 9.1: 5.1 at ear level plus four Auro height channels stacked above the mains and surrounds.
...
- the sub gets a **generous ≤400 Hz** (gentle 12 dB/oct) **mono sum** of all full-range channels — `L`, `R`, `C`, `Ls`, `Rs`, `HL`, `HR`, `HLs`, `HRs`;
...
- Machine-readable spec: [`auro_9_1.renderer.json`](./auro_9_1.renderer.json)
- `kernelSha256`: `7dffa9f78e51e2a196967ee9150220f62215c83fa4913ce602fa24247437ef59`
