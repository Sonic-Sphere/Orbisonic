# Dolby 7.1.4 — Sonic Sphere renderer spec

- **Layout id:** `7_1_4`  ·  **Family:** dolby  ·  **Channels:** 12  ·  **Sub:** discrete LFE + mono bass downmix
...
7.1 plus four overhead channels (top-front + top-rear) — the canonical immersive bed shape (a.k.a. the Dolby Atmos 7.1.4 bed). Sides, rears, and both height rows each map to their own dome region.
...
| 8 | `Ltf` | topFrontLeft | -45 | 45 | -0.500 | 0.500 | 0.707 |  |
| 9 | `Rtf` | topFrontRight | 45 | 45 | 0.500 | 0.500 | 0.707 |  |
| 10 | `Ltr` | topRearLeft | -135 | 45 | -0.500 | -0.500 | 0.707 |  |
| 11 | `Rtr` | topRearRight | 135 | 45 | 0.500 | -0.500 | 0.707 |  |
...
- the sub gets a **generous ≤400 Hz** (gentle 12 dB/oct) **mono sum** of all full-range channels — `L`, `R`, `C`, `Lss`, `Rss`, `Lrs`, `Rrs`, `Ltf`, `Rtf`, `Ltr`, `Rtr`;
...
- Machine-readable spec: [`7_1_4.renderer.json`](./7_1_4.renderer.json)
- `kernelSha256`: `9f53ed5e3eeda9e4cdf4ef2e9a1da82a5eca77a55cf5defef1aba9781b278086`
