...
- **Layout id:** `auro_11_1_7_1_4h`  ·  **Family:** auro  ·  **Channels:** 12  ·  **Sub:** discrete LFE + mono bass downmix
...
- the sub gets a **generous ≤400 Hz** (gentle 12 dB/oct) **mono sum** of all full-range channels — `L`, `R`, `C`, `Ls`, `Rs`, `Lb`, `Rb`, `HL`, `HR`, `HLs`, `HRs`;
