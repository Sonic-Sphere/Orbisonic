...
- **Layout id:** `7_1_2`  ·  **Family:** dolby  ·  **Channels:** 10  ·  **Sub:** discrete LFE + mono bass downmix
...
- the sub gets a **generous ≤400 Hz** (gentle 12 dB/oct) **mono sum** of all full-range channels — `L`, `R`, `C`, `Lss`, `Rss`, `Lrs`, `Rrs`, `Ltm`, `Rtm`;
