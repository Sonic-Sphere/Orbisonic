...
Auro-3D 8.0: an ear-level L/R + side ring with a height layer stacked directly ABOVE it (HL/HR/HLs/HRs), rather than overhead like Atmos. No LFE.
...
| 2 | `Ls` | sideLeft | -110 | 0 | -0.940 | -0.342 | 0.000 |  |
| 3 | `Rs` | sideRight | 110 | 0 | 0.940 | -0.342 | 0.000 |  |
| 4 | `HL` | heightFrontLeft | -30 | 30 | -0.433 | 0.750 | 0.500 |  |
| 5 | `HR` | heightFrontRight | 30 | 30 | 0.433 | 0.750 | 0.500 |  |
| 6 | `HLs` | heightRearLeft | -110 | 30 | -0.814 | -0.296 | 0.500 |  |
| 7 | `HRs` | heightRearRight | 110 | 30 | 0.814 | -0.296 | 0.500 |  |
...
- Machine-readable spec: [`auro_8_0.renderer.json`](./auro_8_0.renderer.json)
- `kernelSha256`: `5ab3147571e6e9ad659c42f5641df4344fda587471283c2dbd7fe3fae22dae14`
