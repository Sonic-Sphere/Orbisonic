...
- **Layout id:** `5_1_2`  ·  **Family:** dolby  ·  **Channels:** 8  ·  **Sub:** discrete LFE + mono bass downmix
...
- the sub gets a **generous ≤400 Hz** (gentle 12 dB/oct) **mono sum** of all full-range channels — `L`, `R`, `C`, `Ls`, `Rs`, `Ltm`, `Rtm`;
