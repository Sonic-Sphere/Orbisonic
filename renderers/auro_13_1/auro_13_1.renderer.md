# Auro 13.1 — Sonic Sphere renderer spec

- **Layout id:** `auro_13_1`  ·  **Family:** auro  ·  **Channels:** 14  ·  **Sub:** discrete LFE + mono bass downmix
...
Auro-3D 13.1: the largest Auro bed — 7.1-style base, a five-wide height layer with height-center, and a Top channel.
...
| 12 | `T` | topCenter | 0 | 90 | 0.000 | 0.000 | 1.000 |  |
| 13 | `HC` | heightCenter | 0 | 30 | 0.000 | 0.866 | 0.500 |  |
...
| `HC` | heightCenter | #23@+0°:0.47, #28@-36°:0.45, #29@+36°:0.45, #17@-36°:0.37, #18@+36°:0.37 |
...
- the sub gets a **generous ≤400 Hz** (gentle 12 dB/oct) **mono sum** of all full-range channels — `L`, `R`, `C`, `Ls`, `Rs`, `Lb`, `Rb`, `HL`, `HR`, `HLs`, `HRs`, `T`, `HC`;
...
- Machine-readable spec: [`auro_13_1.renderer.json`](./auro_13_1.renderer.json)
- `kernelSha256`: `9e27e622c38751a02c97c7cc3a4d6e9801cd990a6b526781a804cbcb5553ee48`
