# Auro 11.1 (5+5H+T) — Sonic Sphere renderer spec

- **Layout id:** `auro_11_1_5_1_5h_t`  ·  **Family:** auro  ·  **Channels:** 12  ·  **Sub:** discrete LFE + mono bass downmix
...
Auro-3D 11.1 (5.1 + 5 height + Top): 5.1 base, a five-wide height layer including a height-center (HC), and a Top channel.
...
| 11 | `HC` | heightCenter | 0 | 30 | 0.000 | 0.866 | 0.500 |  |
...
- the sub gets a **generous ≤400 Hz** (gentle 12 dB/oct) **mono sum** of all full-range channels — `L`, `R`, `C`, `Ls`, `Rs`, `HL`, `HR`, `HLs`, `HRs`, `T`, `HC`;
...
- Machine-readable spec: [`auro_11_1_5_1_5h_t.renderer.json`](./auro_11_1_5_1_5h_t.renderer.json)
- `kernelSha256`: `3637197d38c08d71a39fb8b2ea39036bd5189b1847d525a299d4a7b82f4d2183`
