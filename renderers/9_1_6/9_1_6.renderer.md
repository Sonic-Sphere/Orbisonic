# Dolby 9.1.6 — Sonic Sphere renderer spec

- **Layout id:** `9_1_6`  ·  **Family:** dolby  ·  **Channels:** 16  ·  **Sub:** discrete LFE + mono bass downmix
...
The widest bed here: 9.1.4 plus two extra 'top-middle' overheads — wide fronts, full side+rear surrounds, and a six-speaker height layer for dense overhead detail.
...
| 4 | `Lw` | wideLeft | -60 | 0 | -0.866 | 0.500 | 0.000 |  |
| 5 | `Rw` | wideRight | 60 | 0 | 0.866 | 0.500 | 0.000 |  |
| 6 | `Lss` | sideLeft | -90 | 0 | -1.000 | 0.000 | 0.000 |  |
| 7 | `Rss` | sideRight | 90 | 0 | 1.000 | 0.000 | 0.000 |  |
| 8 | `Lrs` | rearLeft | -135 | 0 | -0.707 | -0.707 | 0.000 |  |
| 9 | `Rrs` | rearRight | 135 | 0 | 0.707 | -0.707 | 0.000 |  |
| 10 | `Ltf` | topFrontLeft | -45 | 45 | -0.500 | 0.500 | 0.707 |  |
| 11 | `Rtf` | topFrontRight | 45 | 45 | 0.500 | 0.500 | 0.707 |  |
| 12 | `Ltr` | topRearLeft | -135 | 45 | -0.500 | -0.500 | 0.707 |  |
| 13 | `Rtr` | topRearRight | 135 | 45 | 0.500 | -0.500 | 0.707 |  |
| 14 | `Ltm` | topMiddleLeft | -90 | 45 | -0.707 | 0.000 | 0.707 |  |
| 15 | `Rtm` | topMiddleRight | 90 | 45 | 0.707 | 0.000 | 0.707 |  |
...
| `Lw` | wideLeft | #11@-72°:0.47, #17@-36°:0.47, #22@-73°:0.44, #6@-41°:0.44, #16@-108°:0.24 |
| `Rw` | wideRight | #13@+72°:0.47, #18@+36°:0.47, #24@+72°:0.45, #7@+41°:0.44, #19@+108°:0.24 |
...
- the sub gets a **generous ≤400 Hz** (gentle 12 dB/oct) **mono sum** of all full-range channels — `L`, `R`, `C`, `Lw`, `Rw`, `Lss`, `Rss`, `Lrs`, `Rrs`, `Ltf`, `Rtf`, `Ltr`, `Rtr`, `Ltm`, `Rtm`;
...
- Machine-readable spec: [`9_1_6.renderer.json`](./9_1_6.renderer.json)
- `kernelSha256`: `2f84427390372bcfc9b119e242a87e5af16a3da8d37b8d34c161f6bc32372487`
