...
- **Layout id:** `harmony_bloom_8ch`  ·  **Family:** custom  ·  **Channels:** 8  ·  **Sub:** derived mono bass downmix
...
- the sub gets a **generous ≤400 Hz** (gentle 12 dB/oct) **mono sum** of all full-range channels — `HB1`, `HB2`, `HB3`, `HB4`, `HB5`, `HB6`, `HB7`, `HB8`;
