...
- **Layout id:** `binaural_2_0_narrow`  ·  **Family:** binaural  ·  **Channels:** 2  ·  **Sub:** derived mono bass downmix
...
- the sub gets a **generous ≤400 Hz** (gentle 12 dB/oct) **mono sum** of all full-range channels — `LeftEar`, `RightEar`;
