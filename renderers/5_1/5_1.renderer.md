# 5.1 — Sonic Sphere renderer spec

- **Layout id:** `5_1`  ·  **Family:** dolby  ·  **Channels:** 6  ·  **Sub:** discrete LFE + mono bass downmix
...
- the sub gets a **generous ≤400 Hz** (gentle 12 dB/oct) **mono sum** of all full-range channels — `L`, `R`, `C`, `Ls`, `Rs`;
...
- Machine-readable spec: [`5_1.renderer.json`](./5_1.renderer.json)
- `kernelSha256`: `61d04428eaffd5774118a6e066b857b7362ed2ec093eefcaaf8526c15ee38b87`
