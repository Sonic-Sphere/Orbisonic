# Dolby 9.1.4 — Sonic Sphere renderer spec

- **Layout id:** `9_1_4`  ·  **Family:** dolby  ·  **Channels:** 14  ·  **Sub:** discrete LFE + mono bass downmix
...
7.1.4 plus a pair of 'wide' front channels at ±60° that fill the gap between front L/R and the side surrounds, widening and smoothing the frontal stage.
...
- the sub gets a **generous ≤400 Hz** (gentle 12 dB/oct) **mono sum** of all full-range channels — `L`, `R`, `C`, `Lw`, `Rw`, `Lss`, `Rss`, `Lrs`, `Rrs`, `Ltf`, `Rtf`, `Ltr`, `Rtr`;
...
- Machine-readable spec: [`9_1_4.renderer.json`](./9_1_4.renderer.json)
- `kernelSha256`: `5410d96427c2bf3782600708c1fe659ac53ea253b58097735dfc09aa305d4959`
